...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  /**
   * useActionState() hook is used to associate state with the result of a form action.
   * After calling createInvoice we receive new state information which might contain validation errors
   * to display.
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                required
                defaultValue={state.data?.get('amount')?.toString()}
              />
